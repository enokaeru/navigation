...
class TestSegmentTree(unittest.TestCase):
    ...
    def test_prefixsum_id3(self):
        ...
        assert tree.find_prefixsum_idx(0.00) == 0
        assert tree.find_prefixsum_idx(0.44) == 0
        assert tree.find_prefixsum_idx(0.5) == 1
        assert tree.find_prefixsum_idx(1.0) == 1
        assert tree.find_prefixsum_idx(1.1) == 1
        assert tree.find_prefixsum_idx(1.5) == 2
        assert tree.find_prefixsum_idx(2.0) == 2
        assert tree.find_prefixsum_idx(2.5) == 3
        assert tree.find_prefixsum_idx(3.1) == 3

    def test_prefixsum_id4(self):
        tree = SumSegmentTree(4)
        ...
        assert tree.find_prefixsum_idx(1.3) == 1
        assert tree.find_prefixsum_idx(3.0) == 2
        assert tree.find_prefixsum_idx(3.8) == 2
        assert tree.find_prefixsum_idx(8.0) == 3
        assert tree.find_prefixsum_idx(8.3) == 3
